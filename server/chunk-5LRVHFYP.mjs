...
import{a as e}from"./chunk-NW7RVBCE.mjs";var E="pbrVertexShader",i=`#define PBR_VERTEX_SHADER
...
}`;e.ShadersStoreWGSL[E]||(e.ShadersStoreWGSL[E]=i);var P={name:E,shader:i};export{P as a};
