...
import{a as e}from"./chunk-NW7RVBCE.mjs";var o="gaussianSplattingVertexDeclaration",c="attribute vec2 position;uniform mat4 view;uniform mat4 projection;uniform mat4 world;uniform vec4 vEyePosition;";e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=c);var s="gaussianSplattingUboDeclaration",r=`#include<sceneUboDeclaration>
#include<meshUboDeclaration>
attribute vec2 position;`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=r);var a="gaussianSplatting",n=`#if !defined(WEBGL2) && !defined(WEBGPU) && !defined(NATIVE)
...
vCenter 
+ ((meshPos.x*majorAxis
+ meshPos.y*minorAxis)*invViewport*pos2d.w)*scale,pos2d.zw);}`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=n);var t="gaussianSplattingVertexShader",i=`#include<__decl__gaussianSplattingVertex>
...
`;e.ShadersStore[t]||(e.ShadersStore[t]=i);var V={name:t,shader:i};export{V as a};
