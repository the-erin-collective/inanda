...
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=G);var r="pbrFragmentExtraDeclaration",y=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
varying vec4 vColor;
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=y);var a="samplerFragmentAlternateDeclaration",V=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=V);var o="pbrFragmentSamplersDeclaration",H=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=W);var c="pbrDirectLightingSetupFunctions",Y=`struct preLightingInfo
...
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=Y);var l="pbrDirectLightingFalloffFunctions",X=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=X);var d="pbrDirectLightingFunctions",k=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
...
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=k);var s="pbrIBLFunctions",w=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=q);var u="pbrBlockAlphaFresnel",Z=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=Z);var S="pbrBlockAnisotropic",J=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=J);var m="pbrBlockReflection",j=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=j);var A="pbrBlockSheen",Q=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStore[A]||(e.IncludesShadersStore[A]=Q);var I="pbrBlockClearcoat",$=`struct clearcoatOutParams
...
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=ee);var N="pbrBlockSubSurface",ie=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[N]||(e.IncludesShadersStore[N]=ie);var O="pbrBlockNormalGeometric",ne=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStore[O]||(e.IncludesShadersStore[O]=ne);var p="pbrBlockNormalFinal",re=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=re);var T="pbrBlockLightmapInit",ae=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=ae);var L="pbrBlockGeometryInfo",oe=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=oe);var g="pbrBlockReflectance0",te=`float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=fe);var _="pbrBlockDirectLighting",ce=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=ce);var M="pbrBlockFinalLitComponents",le=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStore[M]||(e.IncludesShadersStore[M]=le);var h="pbrBlockFinalUnlitComponents",de=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
#endif
`;e.IncludesShadersStore[b]||(e.IncludesShadersStore[b]=Ce);var i="pbrPixelShader",B=`#define PBR_FRAGMENT_SHADER
