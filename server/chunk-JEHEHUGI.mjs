...
#endif
result.Diffuse=LTCEvaluate( normal,viewDir,position,mat3( 1.0 ),rectCoords );return result;}`;o.IncludesShadersStore[t]||(o.IncludesShadersStore[t]=e);
