...
import{a as e}from"./chunk-NW7RVBCE.mjs";var n="pbrVertexDeclaration",r=`uniform mat4 view;uniform mat4 viewProjection;uniform vec4 vEyePosition;
#ifdef MULTIVIEW
...
`;e.ShadersStore[i]||(e.ShadersStore[i]=E);var H={name:i,shader:E};export{H as a};
